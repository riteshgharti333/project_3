...
// Fake data for multiple photo albums
const photoAlbumsData = [
  { id: 1, title: "Jeniffer in Green", description: "By Jonathon Willson", image: m1 },
  { id: 2, title: "California Dreaming", description: "By Mary Doe", image: m1 },
  { id: 3, title: "Mountain Adventures", description: "By Emily Carter", image: m1 },
  { id: 4, title: "Autumn in Paris", description: "By Michael Smith", image: m1 },
  { id: 5, title: "Winter Wonderland", description: "By Sarah Brown", image: m1 },
  { id: 6, title: "Desert Dunes", description: "By Oliver James", image: m1 },
];

const PhotoAlbums = () => {
  const swiperRef = useRef(null);
  const [isSwiperReady, setIsSwiperReady] = useState(false); // To track Swiper readiness
  ...
  const animateSlides = () => {
    ...
    gsap.fromTo(
      ...
      { scale: 0.8, opacity: 0 },
      {
        ...
        duration: 0.6,
        ease: "power2.out",
        delay: 0.2, // Add a delay for sequential effects
      }
    );
  };
  ...
  const handleSwiperInit = (swiper) => {
    ...
    setIsSwiperReady(true); // Set Swiper as ready for animation
  };
  ...
  return (
    <div className="photoAlbums">
      ...
      <p className="photoAlbums-desc">Collection of photos All of Your Best Works</p>
